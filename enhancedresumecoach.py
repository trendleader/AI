...
if os.path.exists(env_path):
    ...
    st.error("⚠️ test.env file not found. Please ensure your OpenAI API key is in the test.env file.")
...
try:
    ...
    st.error("Please install OpenAI package: pip install openai")
    openai_client = None
...
class InterviewAgent(AIAgent):
    """AI Agent for conducting interview practice sessions"""
    
    def __init__(self):
        super().__init__("Interview Coach AI", "Behavioral & Technical Interview Practice")
...
class JobAlignmentAgent(AIAgent):
    """AI Agent for analyzing job-resume alignment and fit scoring"""
    
    def __init__(self):
        super().__init__("Job Alignment AI", "Resume-Job Description Fit Analysis")
...
class CoverLetterAgent(AIAgent):
    """AI Agent for generating personalized cover letters using OpenAI GPT"""
    
    def __init__(self):
        super().__init__("Cover Letter AI", "GPT-Powered Cover Letter Generation")
        self.templates = {
...
class JobSearchAgent(AIAgent):
    """AI Agent for targeted job search by region"""
    
    def __init__(self):
        super().__init__("Job Search AI", "Regional Job Discovery & Matching")
...
class RecommendationAgent(AIAgent):
    """AI Agent for personalized career recommendations using OpenAI GPT"""
    
    def __init__(self):
        super().__init__("Recommendation AI", "GPT-Powered Career Guidance")
...
def main():
    ...
    st.markdown("""
        <div class="main-header">
            <h1 style="color: #1f2937; font-size: 2.5rem; margin-bottom: 0.5rem;">
                AI Resume & Interview Coach Pro
            </h1>
            <p style="color: #6b7280; font-size: 1.1rem;">
                Powered by Advanced AI Agents & Machine Learning
            </p>
        </div>
    """, unsafe_allow_html=True)
    ...
    st.markdown("""
        <div style="text-align: center; color: rgba(255,255,255,0.7); font-size: 0.9rem;">
            Enhanced with AI Agents: Interview Practice • Job Fit Analysis • Cover Letter Generation • Regional Job Search • Personalized Recommendations
        </div>
    """, unsafe_allow_html=True)
